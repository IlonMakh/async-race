...
export default class WinnersView {
    ...
    drawWinners() {
        ...
        <div class='winners hide'>
            <h3 class='winners_title'>Winners</h3>
            <div class='winners_page'>Page</div>
    ...
    drawPagination() {
        ...
        <div class='winners_pagination'>
            <button class='winners_prev'>prev</button>
